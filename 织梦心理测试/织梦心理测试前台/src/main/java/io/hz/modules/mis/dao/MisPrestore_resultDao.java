...
public interface MisPrestore_resultDao extends BaseMapper<MisPrestore_resultEntity> {
    @Select("select b.title as tname,a.id,a.result,a.details,a.maxscore,a.minscore from mis_prestore_result a,mis_test b where a.tid=b.id and b.title like '%${tname}%'")
